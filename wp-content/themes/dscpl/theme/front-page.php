...
?>
 ...
 <main>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16 lg:py-0">
          ...
          <div class="text-white">
            ...
            <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <a href="#"
                ...
                Start Free Trial <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Arrow right.svg" alt="arrow" class="mt-1 ml-2">
              </a>
              <a href="#"
          ...
          <div class="relative w-full h-[600px] overflow-hidden">
            <div class="flex flex-col animate-slide-vertical space-y-12">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/girl.svg" alt="Girl" class="h-64 w-auto">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/groupmens.svg" alt="Group" class="rounded-full h-48">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/girl.svg" alt="Girl" class="h-64 w-auto">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/groupmens.svg" alt="Group" class="rounded-full h-48">
            </div>
          </div>
      ...
      <div class="mx-auto px-4">
        ...
        <div class="overflow-hidden relative">
          <div class="flex items-center gap-12 animate-slide">
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/microsoft-logo.svg" alt="Microsoft" class="h-[35px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/metallb.svg" alt="Microsoft" class="h-[40px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/linked.svg" alt="MetalLB" class="h-[40px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Insta.svg" alt="LinkedIn" class="h-[40px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/pay.svg" alt="Instagram" class="h-[40px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/microsoft-logo.svg" alt="Microsoft" class="h-[35px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/metallb.svg" alt="Microsoft" class="h-[40px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/linked.svg" alt="MetalLB" class="h-[40px] w-[163px] object-contain" />
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Insta.svg" alt="LinkedIn" class="h-[40px] w-[163px] object-contain" />
        ...
        <div class="mt-10 text-center">
          <a href="#"
            ...
            VIEW SUCCESS STORIES <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Arrow-right.svg" alt="arrow" class="mt-1 ml-2">
          </a>
        </div>
      </div>
    </section>
    <section class="py-8 bg-[#E0F7FA] relative overflow-hidden m-4 rounded-xl">
      <div>
        <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/vector.svg" alt="background image" class="absolute top-60 right-[6%]" />
        <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/vector.svg" alt="background image" class="absolute top-30 left-[5%] w-[200px]" />
        <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/vector.svg" alt="background image" class="absolute bottom-0 left-[0%] w-[200px] " />
      </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8 justify-center items-stretch">
          <div
            ...
            <div class="p-2 sm:p-4 md:p-8">
              ...
              <a href="#"
                class="transform hover:scale-[1.01] transition duration-300 inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-lg text-white  bg-gradient-to-br from-[#6CD3E7] to-[#235A66] hover:bg-[#1a5b5d] transition duration-300 shadow-lg">
                Contact Sales <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Arrow right.svg" alt="arrow" class="mt-1 ml-2">
              </a>
            </div>
            <div class="h-64 overflow-hidden m-4">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/scanning.jpg" alt="Warehouse"
          ...
          <div
            ...
            <div class="p-2 sm:p-4 md:p-8">
              ...
              <a href="#"
                class="transform hover:scale-[1.01] transition duration-300 inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-lg text-white  bg-gradient-to-br from-[#6CD3E7] to-[#235A66] hover:bg-[#1a5b5d] transition duration-300 shadow-lg">
                Learn more <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Arrow right.svg" alt="arrow" class="mt-1 ml-2">
              </a>
            </div>
            <div class="h-64 overflow-hidden m-4">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/worker.jpg" alt="Warehouse" class="w-full h-full object-cover object-right" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="py-16 bg-white relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div class="lg:w-1/2 relative w-full flex justify-center lg:justify-end">
          <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Group.svg" alt="DSCPL Logo" class="w-auto">
        </div>
      </div>
    </section>
    <section class="py-8 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 text-center">
          <div>
            <p class="text-2xl sm:text-3xl md:text-4xl font-bold text-accent-orange">0.1M</p>
          ...
          <div>
            <p class="text-2xl sm:text-3xl md:text-4xl font-bold text-accent-orange">$001+</p>
            <p class="mt-2 text-[#2E3A65] font-bold">Transactions Handled</p>
          </div>

          <div>
            <p class="text-2xl sm:text-3xl md:text-4xl font-bold text-accent-orange">01%</p>
    ...
    <section class="py-4 stakeholders-section  relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/vector.svg" alt="background image" class="absolute bottom-40 right-[1%]" />
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 justify-items-center">
          <div class="stakeholder-card">
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/manufacturer.jpg" alt="DSCPL Logo" class="card_img" />
            </div>
          ...
          <div class="stakeholder-card">
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/distribute.jpg" alt="DSCPL Logo" class="card_img">
            </div>
          ...
          <div class="stakeholder-card">
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/retails.jpg" alt="DSCPL Logo" class="card_img">
            </div>
          ...
          <div class="stakeholder-card">
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/brands.jpg" alt="DSCPL Logo" class="card_img">
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 h-auto min-h-[400px]">
          ...
          <div id="feature-1" class="flip-card">
            <div class="flip-card-inner">
              ...
              <div class="flip-card-back">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/saless.svg" alt="Sales App Screenshot 1">
                <div>
          ...
          <div id="feature-2" class="flip-card">
            <div class="flip-card-inner">
              ...
              <div class="flip-card-back">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/invent.svg" alt="Inventory App Screenshot 1">
                <div>
          ...
          <div id="feature-3" class="flip-card">
            <div class="flip-card-inner">
              ...
              <div class="flip-card-back">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/smart.svg" alt="Logistics App Screenshot 1">
                <div>
          ...
          <div id="feature-4" class="flip-card">
            <div class="flip-card-inner">
              ...
              <div class="flip-card-back">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/reporting.svg" alt="Reporting App Screenshot 1">
                <div>
          ...
          <div id="feature-5" class="flip-card">
            <div class="flip-card-inner">
              ...
              <div class="flip-card-back">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/integrate.svg" alt="Payments App Screenshot 1">
                <div>
      ...
      <div class="py-4 max-w-7xl mx-auto px-4 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="grid grid-cols-2 max-[490px]:grid-cols-1 gap-6 justify-center image-block mx-auto">
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/smilegirl.svg" alt="Person on phone looking at tablet"
                class="w-[165px] h-[167px] object-cover mx-auto">
            </div>
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/WORK.svg" alt="Warehouse worker holding boxes"
                class="w-[165px] h-[167px] object-cover mx-auto">
            </div>
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/mobilegirl.svg" alt="Forklift driver on phone"
                class="w-[165px] h-[167px] object-cover mx-auto">
            </div>
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/FEMALE.svg" alt="Female delivery person with boxes"
    ...
    <section class="py-8 bg-white relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 gap-6 mb-6">
          <div
            ...
            <div>
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/dashscreen.svg" alt="dashboard">
            </div>
          </div>
          ...
          <div class="mx-4 lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              ...
              <div class="space-y-4">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/menucard.svg" alt="menucard" class=" mt-0 sm:mt-16 mx-auto">
              </div>
            </div>
            ...
            <div
              ...
              <div class="space-y-4">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/dashfull.svg" alt="menucard" class="mt-4 sm:mt-8 md:mt-16 mx-auto">
              </div>
            </div>
        ...
        <div
          ...
          <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/swap.svg" alt="menucard" class="mt-4 sm:mt-8 md:mt-16 mx-auto">
      ...
      <div class="flex justify-center mt-8">
        <a href="#"
          ...
          Explore now<img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/Arrow right.svg" alt="arrow" class="mt-1">
        </a>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="flex flex-col">
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/truck.svg" alt="FMCG Delivery"
          ...
          <div class="space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 items-start">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/saas.svg" alt="Retail" class="w-full h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 items-start">
              <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/warehouse.svg" alt="Analytics" class="w-full h-auto rounded-lg"
                onerror="this.style.display='none'">
              <div class="p-4 sm:col-span-2">
                <div class="flex flex-wrap items-center text-xs text-[#2E7382] mb-2 font-medium">
