            ...
            <div class="rounded-lg p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col">
                        ...
                        <input type="text" placeholder="Your name" class="w-full border shadow-lg rounded-lg px-4 py-3 h-12
               text-[15px] placeholder-gray-500 placeholder:font-medium placeholder:normal-case
               focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>

                    <div class="flex flex-col">
                        <label class="text-gray-700 text-sm mb-4 font-bold">Email</label>
                        <input type="email" placeholder="Your email address" class="w-full shadow-lg border rounded-lg px-4 py-3 h-12
               text-[15px] placeholder-gray-500 placeholder:font-medium placeholder:normal-case
               focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" placeholder="Your Company name" class="w-full border shadow-lg rounded-lg px-4 py-3 h-12
             text-[15px] placeholder-gray-500 placeholder:font-medium placeholder:normal-case
             focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <textarea placeholder="Write your message here..." class="w-full border shadow-lg rounded-lg px-4 py-3 h-36 resize-y
             text-[15px] placeholder-gray-500 placeholder:font-medium placeholder:normal-case
